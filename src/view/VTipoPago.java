 ...
 * @author home
 */
public class VTipoPago extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipos de Pago", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Print", 0, 18))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Agregar nuevo tipo de pago", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Print", 0, 11))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtNombreNew, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Modificar Datos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Print", 0, 11))); // NOI18N
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try{
            ...
            FnTipoPago load = new FnTipoPago();
            TipoPago temp = load.cargar(id);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(nombre.length() > 3){
            ...
            TipoPago nueva= new TipoPago(0, nombre, estado);
            FnTipoPago fn = new FnTipoPago();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        TipoPago mod = new TipoPago(id, nombre, estado);
        FnTipoPago load = new FnTipoPago();
        try {
    ...
    private void cargarDatos(int listar) {
        ...
        FnTipoPago datbd= new FnTipoPago();
        int cont =0;
        try{
            for (TipoPago temp : datbd.listar(listar)) {
    ...
    private void buscarDatos(String buscar, int i) {
        ...
        int cont =0;
        try{
            for (TipoPago temp : datbd.buscar(buscar,i)) {
                Object[] fila = new Object[2];
                fila[0] = temp.getId();
                fila[1] = temp.getNombre();
                modelo.addRow(fila);
