 ...
 * @author sdx
 */
public class OpanelSelectAdminToSendMail extends javax.swing.JPanel {
     ...
     */
    public OpanelSelectAdminToSendMail() {
        initComponents();
        stList = load.listar("0", new User());
        try {
            autocompletar();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(OpanelSelectAdminToSendMail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
