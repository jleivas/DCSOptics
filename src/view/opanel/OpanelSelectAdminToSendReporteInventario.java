 ...
 * @author sdx
 */
public class OpanelSelectAdminToSendReporteInventario extends javax.swing.JPanel {
     ...
     */
    public OpanelSelectAdminToSendReporteInventario() {
        initComponents();
        stList = load.listar("0", new User());
        try {
            autocompletar();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(OpanelSelectAdminToSendReporteInventario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione un destinatario");
    ...
    private void btnLoadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoadMouseClicked
        ...
        if(idUser.contains("<")){
            ...
            User user = (User)GV.buscarPorIdEnLista(idUser, stList, new User());
            if(user!=null){
                ...
                try{
                    GlobalValuesFunctions.sendReporteInventarioMail(user.getEmail(),"Reporte de inventario: "+GlobalValuesVariables.LENTES_INVENTARIO);
                }catch(Exception e){
                    GV.cursorDF(this);
