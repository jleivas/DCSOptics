 ...
 * @author sdx
 */
public class OpanelSelectClient extends javax.swing.JPanel {
    Boton boton = new Boton();
    /**
     * Creates new form OpanelSelectDate
     */
    public OpanelSelectClient() {
        initComponents();
        try {
            autocompletar();
    ...
    private void btnLoadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoadMouseClicked
        String rut = txtNombreCliente.getText();
        if(rut.contains("<")){
            try {
    ...
    private void autocompletar() throws SQLException, ClassNotFoundException {
        Dao load = new Dao();
        TextAutoCompleter textAutoCompleter2 = new TextAutoCompleter(txtNombreCliente);
        for (Object temp : load.listar("0", new Cliente())) {
            textAutoCompleter2.addItem(((Cliente)temp).getNombre()+" <"+((Cliente)temp).getCod()+">");
