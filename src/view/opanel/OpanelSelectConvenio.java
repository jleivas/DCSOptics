 ...
 * @author sdx
 */
public class OpanelSelectConvenio extends javax.swing.JPanel {
     ...
     */
    public OpanelSelectConvenio() {
        initComponents();
        stList = load.listar("0", new Convenio());
        try {
            autocompletar();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(OpanelSelectConvenio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione un convenio");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNombreConvenio, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnLoadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoadMouseClicked
        GV.cursorWAIT(this);
        String id = txtNombreConvenio.getText();
        if(id.contains("<")){
            id = id.substring(id.indexOf("<")+1);
            id = id.replaceAll(">", "");
            Convenio conv = (Convenio)GV.buscarPorIdEnLista(id, stList, new Convenio());
            if(conv!=null){
                try {
                    GV.setConvenio(conv);
                    OptionPane.closeOptionPanel();
                    ...
                    OptionPane.showMsg("Error al cargar el convenio", "Error al seleccionar convenio\n"
            ...
            OptionPane.showMsg("El convenio no existe", "Debe seleccionar un convenio de la lista desplegable", 2);
        }
        GV.cursorDF(this);
