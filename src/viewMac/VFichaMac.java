 ...
 * @author home
 */
public class VFichaMac extends javax.swing.JPanel {
     ...
     */
    public VFichaMac() throws SQLException, ClassNotFoundException {
    ...
    private void cargarDatos() throws SQLException, ClassNotFoundException {
        ...
        if(ficha.getConvenio() !=null && 
            ...
            ContentAdminMac.lblTitle.setText("Receta oftalmológica "+getEstado()+" con convenio: "+ficha.getConvenio().getNombre());
        }else{
            ContentAdminMac.lblTitle.setText("Receta oftalmológica "+getEstado()+" generada el "+GV.dateToString(GV.getOpenFicha().getFecha(), "dd.mm.yyyy"));
        }
