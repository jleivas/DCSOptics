 ...
 * @author home
 */
public class VMessagesMac extends javax.swing.JPanel {
     ...
     */
    public VMessagesMac() {
        ContentAdminMac.lblTitle.setText("Registro de mensajes internos");
        initComponents();
        ...
        ContentAdminMac.lblTitle.setText("Mensajes");
    ...
    private void btnEnviarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEnviarMouseClicked
        ...
        if(txtUserDestino.getForeground() == Color.black){
            ...
            try {
                ...
                Logger.getLogger(VMessagesMac.class.getName()).log(Level.SEVERE, null, ex);
            }
            cargarDatos("0");
        }else{
