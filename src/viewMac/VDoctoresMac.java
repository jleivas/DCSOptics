 ...
 * @author home
 */
public class VDoctoresMac extends javax.swing.JPanel {
     ...
     */
    public VDoctoresMac() {
        ContentAdminMac.lblTitle.setText("Registro de profesionales");
//        load.sincronize(new Doctor());
        ...
        ContentAdminMac.lblTitle.setText("Profesionales");
        load();
        loadPanels(1);
        GV.cursorDF();
        cDF();
