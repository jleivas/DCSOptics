 ...
 * @author home
 */
public class VInventariosMac extends javax.swing.JPanel {
     ...
     */
    public VInventariosMac() {
        ContentAdminMac.lblTitle.setText("Registro de inventarios");
//        load.sincronize(new Inventario());
        ...
        try {
            ...
            Logger.getLogger(VInventariosMac.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        ...
        if(isLocal){
            ...
            ContentAdminMac.lblTitle.setText("Inventarios ("+GV.inventarioName()+" asignado a este equipo)");
        }
        cargarDatos("0");
        cDF();
