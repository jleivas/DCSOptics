 ...
 * @author home
 */
public class VCristalesMac extends javax.swing.JPanel {
     ...
     */
    public VCristalesMac() {
        ContentAdminMac.lblTitle.setText("Cristales");
//        load.sincronize(new Cristal());
    ...
    private void btnGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarMouseClicked
        ...
        try {
            ...
            Logger.getLogger(VCristalesMac.class.getName()).log(Level.SEVERE, null, ex);
